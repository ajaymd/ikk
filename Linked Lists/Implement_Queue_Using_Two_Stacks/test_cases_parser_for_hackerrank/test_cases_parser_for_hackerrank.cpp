...
void copy_output()
{
	string file_name = file_name_for_next_output();
	freopen(file_name.c_str(), "w", stdout);
	int N = number_of_dequeues[0];
	number_of_dequeues = vector<int>(number_of_dequeues.begin() + 1, number_of_dequeues.end());
	for (int i = 0; i < N; i++)
	{
		int no;
		cin >> no;
...
void copy_input()
{
	...
	number_of_dequeues.push_back(dequeue);
}
...
int main()
{
	...
	parse_test_cases("..//test_cases//handmade_test_cases_input.txt", "..//test_cases//handmade_test_cases_output.txt", 9);
	parse_test_cases("..//test_cases//small_test_cases_input.txt", "..//test_cases//small_test_cases_output.txt", 15);
	parse_test_cases("..//test_cases//big_test_cases_input.txt", "..//test_cases//big_test_cases_output.txt", 3);
