...
void parse_test_cases(string copy_input_from, string copy_output_from, int no_of_test_cases)
{
	...
	// This is necessary! See the input file and will get it.
...
int main()
{
	...
	parse_test_cases("..//test_cases//generated_small_test_cases_input.txt", "..//test_cases//generated_small_test_cases_expected_output.txt", 10);
