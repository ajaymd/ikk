...
$classname = "IK5Feb22GraphsEtAl"; //(e.g. IK3Dec28Blah)
...
//$sources = array("SAMSUNG", "SAMSUNG1", "SAMSUNG2"); //For days when the class is full. Be sure to name them like this. By default, samsung inserts a space between its name and the number, you will have to manually remove it. Otherwise Bash breaks :-P

//$sources = array("SAMSUNG1", "SAMSUNG2");
