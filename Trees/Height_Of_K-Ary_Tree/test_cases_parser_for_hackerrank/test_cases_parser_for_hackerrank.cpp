...
int main()
{
	...
	parse_test_cases("..//test_cases//handmade_test_cases_input.txt", "..//test_cases//handmade_test_cases_output.txt", 5);
	parse_test_cases("..//test_cases//small_test_cases_input.txt", "..//test_cases//small_test_cases_output.txt", 19);
