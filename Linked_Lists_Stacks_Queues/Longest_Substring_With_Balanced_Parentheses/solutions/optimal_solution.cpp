	...
	for (int i = 0; i < n; i++)
	{
		...
		else
		{
			...
			else
			{
				...
				{
					/*
					In "(())))(())()" when we are at last ')', stack will become empty and valid_from will be at 6th position, so answer that needs to be checked is 11 - 6 + 1 = 6 corresponding to "(())()".   
					*/
				...
				{
					/*
					In "((((())(((()" when we are at last ')', stack will contain [0, 1, 21 7, 8, 9], so answer that needs to be checked is 11 - 9 = 2 corresponding to "()". 
					*/
