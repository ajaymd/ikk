...
void copy_input(ifstream &fin)
{
	...
	fin >> rows >> cols >> start_row >> start_col >> end_row >> end_col;
...
int main()
{
	...
	parse_test_cases("..//test_cases//generated_big_test_cases_input.txt", "..//test_cases//generated_big_test_cases_expected_output.txt", 16);
