...
public class big_test_cases_generator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        PrintWriter pw = new PrintWriter(new File(file.toString() + "/Arrays/Array_Product/test_cases/generated_big_test_cases_input.txt"));
        ...
        for (int testCase = 0; testCase < totalTestCases; testCase++) {
            ...
            int n = 70000 + random.nextInt(100000-70000+1);
    ...
    private static void writeOutput() throws IOException {
        File file = new File(System.getProperty("user.dir"));
        BufferedReader br = new BufferedReader(new FileReader(file.toString() + "/Arrays/Array_Product/test_cases/generated_big_test_cases_input.txt"));
        PrintWriter pw = new PrintWriter(new File(file.toString() + "/Arrays/Array_Product/test_cases/generated_big_test_cases_expected_output.txt"));
