...
bool is_safe(vector<string> &chess_board, vector<bool> &slash_diagonal_occupied, vector<bool> &col_occupied, vector<bool> &back_slash_diagonal_occupied, int row, int col, int n)
{
...
void find_all_arrangements_util(vector<vector<string>> &ret, vector<string> &chess_board, vector<bool> &slash_diagonal_occupied, vector<bool> &col_occupied, vector<bool> &back_slash_diagonal_occupied, int n, int row)
{
	...
	for (int col = 0; col < n; col++)
	{
		...
		if (is_safe(chess_board, slash_diagonal_occupied, col_occupied, back_slash_diagonal_occupied, row, col, n))
		{
			// Place queen.
